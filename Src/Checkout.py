...
class Checkout:
    ...
    def calcular_total(self):
        for item in self.carrito.mostrar_carrito().obtener_elementos():
            if hasattr(item, 'producto'):  # Es un ItemCarrito
                ...
                self.total += item.precio * 1  # Cantidad 1 para productos directos
    ...
    def generar_orden(self, direccion_envio):
        ...
        fecha_envio = fecha_compra + timedelta(days=2)
    ...
    def actualizar_inventario(self):
        for item in self.carrito.mostrar_carrito().obtener_elementos():
            if hasattr(item, 'producto'):  # Es un ItemCarrito
                ...
                item.reducir_stock(1)  # Cantidad 1 para productos directos
    ...
    def crear_recibo(self):
        ...
        if self.orden:
            ...
            raise ValueError("No se puede crear recibo sin orden generada")
